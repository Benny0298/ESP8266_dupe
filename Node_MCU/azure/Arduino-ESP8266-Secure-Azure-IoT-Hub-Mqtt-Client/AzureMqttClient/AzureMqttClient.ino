...
void setup() {
  ...
  // initCloudConfig(HoastName, DeviceID, SharedAccessKey, WiFiSSID, WiFiPASS, Location);
	initCloudConfig("HostName=myEsp.azure-devices.net, DeviceId=myEsp, SharedAccessKey=WczO0tNbQNy/GTlrieKRpqCpTaC7z6UQQpL6NJlwAiE=", "HUAWEI_P30", "zGmT!@.651926", "Vienna");
